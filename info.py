...
# Bot information
SESSION = environ.get('SESSION', 'Newmovie_sbot')
API_ID = int(environ.get('API_ID', '27360374'))
API_HASH = environ.get('API_HASH', 'f7e5c278e2efd8bf0b22f67cac707389')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002477743748'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5308609720').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001672243335').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002269396456') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002484105490')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001841964149')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001672243335')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://DeveloperBoy-A:Jeetesh@1999@developerboya.1txvg.mongodb.net/?retryWrites=true&w=majority&appName=DeveloperBoyA")
DATABASE_NAME = environ.get('DATABASE_NAME', "DeveloperBoy-A")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'DeveloperBoyA')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '33d3046c5fa6900b043b04926fb53d2adfdf6347')
